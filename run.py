...
class ChatbotClient:
    ...
    def __init__(self, api_key=None):
        ...
        # API endpoints
        self.endpoints = {
            'check_api_key': 'https://kkodex123--employee-sentiment-analysis-chatbot-check-api-key.modal.run',
            'start_chat': 'https://kkodex123--employee-sentiment-analysis-chatbot-start-chat.modal.run',
            'chat': 'https://kkodex123--employee-sentiment-analysis-chatbot-chat.modal.run'
        }
    ...
    def start_chat(self, employee_id):
        """Start a new chat session with the given employee ID."""
        print(f"Starting chat for employee {employee_id}...")
        try:
